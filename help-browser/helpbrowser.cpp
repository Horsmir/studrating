...
HelpBrowser::HelpBrowser(QWidget *parent, Qt::WindowFlags f) : QDialog(parent, f), ui(new Ui::helpForm)
{
	ui->setupUi(this);
}

HelpBrowser::HelpBrowser(const QString &path, const QString &page, QWidget *parent) : QDialog(parent), ui(new Ui::helpForm)
{
	ui->setupUi(this);
	...
	ui->textBrowser->setSearchPaths(QStringList() << path << ":/icons");
